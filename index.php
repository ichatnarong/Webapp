...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./lib/fontawesome-free-5.15.3-web/css/all.min.css">
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form validate-form" id="sign_in" method="POST" action="sign-in-verify.php">
                    <span class="login100-form-logo">
                        <!-- <svg style="width:50px;height:50px" viewBox="0 0 23 23">
                        ...
                        <!-- <svg style="width:40; height:40; " viewBox="0 0 64 64">
                            <path fill="currentColor" d="m51.5 27c-.827 0-1.5.673-1.5 1.5s.673 1.5 1.5 1.5 1.5-.673 1.5-1.5-.673-1.5-1.5-1.5z"></path>
                            <path fill="currentColor" d="m40.5 27c-.827 0-1.5.673-1.5 1.5s.673 1.5 1.5 1.5 1.5-.673 1.5-1.5-.673-1.5-1.5-1.5z"></path>
                            <path fill="currentColor" d="m52.5 18c.827 0 1.5-.673 1.5-1.5s-.673-1.5-1.5-1.5-1.5.673-1.5 1.5.673 1.5 1.5 1.5z"></path>
                            <path fill="currentColor" d="m39.5 18c.827 0 1.5-.673 1.5-1.5s-.673-1.5-1.5-1.5-1.5.673-1.5 1.5.673 1.5 1.5 1.5z"></path>
                    ...
                    <?php
                    if ($error == 1) {
                        echo "<span class='errorLogin'>
                                ไม่มีชื่อผู็ใช้นี้ในระบบ
                            </span>";
                    } else if ($error == 2) {
                        echo "<span class='errorLogin'>
                        ...
                        echo "<span class='errorLogin'>
                                บัญชีของคุณถูก Block โปรดติดต่อผู้ดูแลระบบ
                            </span>";
                    } else if ($error == 4) {
                        echo "<span class='errorLogin'>
                                ระยะเวลาในการเปลี่ยนPassword เกิน 5 นาที
                            </span>";;
                    }
                    ?>
