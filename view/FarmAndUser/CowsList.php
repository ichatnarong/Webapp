...
<body>
    <div class="wrapper-ListSearch">
        ...
        <div class="content2">
            ...
            <button class="btn btn-primary btn-sm addCooperative" type="button" onclick="window.location.href='./AddCows.php'">
                <i class="fas fa-plus" style="color: white;"> เพิ่มประชากรโค</i>
            </button>
