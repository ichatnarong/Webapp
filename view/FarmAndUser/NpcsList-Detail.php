                ...
                <div class="col-12">
                    <div class="card shadow">
                        <div class="card-body remove-padding block-image-cow2">
                            <img alt="Image placeholder" class="image-cow" src="../../picture/profile/male Assistant.gif">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body remove-padding">
                            <div class="row row-list">
                                ...
                                <div class="row padding-detail-card">
                                    ...
                                    <div class="col-7">
                                        <span class="span-padding" id="npc_name"></span>
                                    </div>
                                </div>
                                <div class="row padding-detail-card">
                                    <div class="col-5 span-center">
                                    ...
                                    <div class="col-7">
                                        <span class="span-padding" id="npc_lastname"></span>
                                    </div>
                                </div>
                                <div class="row padding-detail-card">
                                    <div class="col-5 span-center">
                                    ...
                                    <div class="col-7">
                                        <span class="span-padding" id="npc_nickname"></span>
                                    </div>
                                </div>
                                <div class="row padding-detail-card">
                                    <div class="col-5 span-center">
                                    ...
                                    <div class="col-7">
                                        <span class="span-padding" id="npc_age"></span>
                                    </div>
                                </div>
...
<script src="./NpcsList-Detail.js"></script>