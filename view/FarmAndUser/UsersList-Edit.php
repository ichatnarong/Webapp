                        ...
                        <div class="card-body remove-padding">
                            <div class="row row-list">
                                ...
                                <div class="row padding-detail-card">
                                    ...
                                    <div class="col-7">
                                        <input class="form-control" id="userlist_name"></input>
                                    </div>
                                </div>
                                <div class="row padding-detail-card">
                                    <div class="col-5 span-center">
                                    ...
                                    <div class="col-7">
                                        <input class="form-control" id="userlist_lastname"></input>
                                    </div>
                                </div>
                                <div class="row padding-detail-card">
                                    <div class="col-5 span-center">
                                    ...
                                    <div class="col-7">
                                        <input class="form-control" id="userlist_nickname"></input>
                                    </div>
                                </div>
                                <div class="row padding-detail-card">
                                    <div class="col-5 span-center">
...
<script src="./UsersList-Edit.js"></script>